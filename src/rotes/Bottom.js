...
export function Bottom(){
    return(
            <Tab.Navigator screenOptions={{tabBarActiveTintColor: Theme.colors.blue[40], tabBarLabelStyle: { fontSize: 14 },  }}>
                ...
                <Tab.Screen name="New" component={CreateArticle} options={{headerShown: false, tabBarButton: (props) => (
                    <TouchableOpacity {...props} style={styles.addButtonContainer}>
                        <Text style={styles.addButton}>+</Text>
                    </TouchableOpacity>
                ) }} />

                <Tab.Screen name="Search" component={Menu} options={{headerShown: false, tabBarIcon: () => { return <SearchSvg/>}, }} />

                <Tab.Screen name="Menu" component={Menu} options={{headerShown: false, tabBarIcon: () => { return <MenuSvg/>}, }} />
